...
exports.UOMImage = void 0;
var typeorm_1 = require("typeorm");
var uom_entity_1 = require("./uom.entity");
var UOMImage = function () {
    ...
    var UOMImage = _classThis = /** @class */ (function () {
        function UOMImage_1() {
    ...
    __setFunctionName(_classThis, "UOMImage");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _imageUrl_decorators = [(0, typeorm_1.Column)()];
        _uom_decorators = [(0, typeorm_1.ManyToOne)(function () { return uom_entity_1.UOM; }, function (uom) { return uom.images; }, { onDelete: 'CASCADE' })];
        ...
        UOMImage = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UOMImage = _classThis;
}();
exports.UOMImage = UOMImage;
