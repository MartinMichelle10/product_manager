...
var Product = function () {
    var _classDecorators = [(0, typeorm_1.Entity)(), (0, typeorm_1.Index)('idx_product_name', ['name'])];
    ...
    (function () {
        ...
        _uoms_decorators = [(0, typeorm_1.OneToMany)(function () { return uom_entity_1.UOM; }, function (uom) { return uom.product; }, { onDelete: 'CASCADE' })];
