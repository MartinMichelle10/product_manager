...
export enum BINDINGS_KEYS {
  ...
  PERSIST_UPDATE_PRODUCT_REQUESTED = 'PERSIST_UPDATE_PRODUCT_REQUESTED',
}
...
export const Bindings: Partial<Record<BINDINGS_KEYS, Binding>> = {
  ...
  [BINDINGS_KEYS.PERSIST_UPDATE_PRODUCT_REQUESTED]: {
    exchange: ExchangesNames.PRODUCT_MANAGER,
    queue: Queues.PERSIST_UPDATE_PRODUCT,
    routingKey: ROUTING_KEYS.PERSIST_UPDATE_PRODUCT_REQUESTED,
  },
};
